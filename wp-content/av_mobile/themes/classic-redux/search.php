...
<div id="content" class="search">
	...
	?>
		...
		<h3 class="search-heading heading-font">
			<?php echo sprintf( __( "%s results" ), av_mobile_get_search_post_type() ); ?>
		</h3>
		...
		<?php if ( has_post_thumbnail() ) { ?>
			<img src="<?php av_mobile_the_post_thumbnail( 160, 120 ); ?>" alt="thumbnail" class="post-thumbnail wp-post-image" />
