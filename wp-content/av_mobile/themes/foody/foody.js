/* WPtouch Foody JS File */

function foody_HandleTextDropDowns() {
...
function foody_BindTappableLinks(){
...
function doFoodyReady() {
	foody_TabletView();
	foody_SwapGalleryNav();
	foody_HandleTextDropDowns();
	foody_HandleTabMenu();
	foody_WebAppMenu();
	foody_BindTappableLinks();
 }

jQuery( document ).ready( function() { doFoodyReady(); } );
