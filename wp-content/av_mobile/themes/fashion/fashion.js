/* WPtouch Fashion JS File */

function fashion_HandleTextDropDowns() {
...
function fashion_HandleTabMenu() {
...
function fashion_SwapGalleryNav(){
...
function fashion_BindTappableLinks(){
...
function doFashionReady() {
	fashion_TabletView();
	fashion_SwapGalleryNav();
	fashion_HandleTextDropDowns();
	fashion_HandleTabMenu();
	fashion_WebAppMenu();
	fashion_BindTappableLinks();
 }

jQuery( document ).ready( function() { doFashionReady(); } );