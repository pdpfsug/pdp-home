/* WPtouch Simple JS File */

function simple_HandleTextDropDowns() {
...
function simple_SwapGalleryNav(){
...
function simple_BindTappableLinks(){
...
function doSimpleReady() {
	simple_TabletView();
	simple_SwapGalleryNav();
	simple_HandleTextDropDowns();
	simple_HandleTabMenu();
	simple_WebAppMenu();
	simple_BindTappableLinks();
 }
