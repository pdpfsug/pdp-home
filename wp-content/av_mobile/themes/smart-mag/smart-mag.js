/* WPtouch Smart Mag JS File */
/* Public functions called here reside in base.js, found in the Foundation theme */

function doSmartMagReady() {
	smartmag_TabletView();
	smartmag_SwapGalleryNav();
	smartmag_HandleTextDropDowns();
	smartmag_HandleTabMenu();
	smartmag_WebAppMenu();
	smartmag_BindTappableLinks();
	smartmag_SearchToggle();
}
 
function smartmag_HandleTextDropDowns() {
...
function smartmag_HandleTabMenu() {
...
function smartmag_SwapGalleryNav(){
...
function smartmag_BindTappableLinks(){
...
function smartmag_SearchToggle(){
	jQuery( '#search-toggle' ).on( 'click', function(){
		jQuery( '#search-dropper' ).toggleClass( 'toggled' );
	});
}

jQuery( document ).ready( function() { doSmartMagReady(); } );
