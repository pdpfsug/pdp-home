...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => __( 'No Repeat', 'forestly' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'forestly' ),
		'repeat-y'  => __( 'Repeat Vertically', 'forestly' ),
		'repeat'    => __( 'Repeat All', 'forestly' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'forestly' ),
		'top center'    => __( 'Top Center', 'forestly' ),
		'top right'     => __( 'Top Right', 'forestly' ),
		'center left'   => __( 'Middle Left', 'forestly' ),
		'center center' => __( 'Middle Center', 'forestly' ),
		'center right'  => __( 'Middle Right', 'forestly' ),
		'bottom left'   => __( 'Bottom Left', 'forestly' ),
		'bottom center' => __( 'Bottom Center', 'forestly' ),
		'bottom right'  => __( 'Bottom Right', 'forestly')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'forestly' ),
		'fixed'  => __( 'Fixed in Place', 'forestly')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __( 'Normal', 'forestly' ),
		'italic'      => __( 'Italic', 'forestly' ),
		'bold'        => __( 'Bold', 'forestly' ),
		'bold italic' => __( 'Bold Italic', 'forestly' )
		);
